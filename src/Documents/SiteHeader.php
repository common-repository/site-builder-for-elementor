...
final class SiteHeader extends Library_Document
{
    ...
    {
        return __('Header', 'site-builder-for-elementor');
    }
    ...
    public function get_container_attributes()
    {
        ...
        $attributes = [
            ...
            'class' => 'elementor elementor-' . $id . ' esb-site-header',
        ];
    ...
    public function print_elements_with_wrapper($data = null)
    {
        ...
        do_action('before_print_esb_site_header', $data);

        ?>
    		<header id="esb-site-header" <?php echo Utils::render_html_attributes($this->get_container_attributes()); ?>>
        ...
        do_action('after_print_esb_site_header', $data);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __('If multiple headers have the same condition, the last updated one will be displayed.', 'site-builder-for-elementor'),
                'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
            ]
        );
